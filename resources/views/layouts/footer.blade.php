    ...
    <div class="px-4 mx-auto max-w-7xl">
        <div class="grid gap-8 md:grid-cols-4">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="{{ route('brands.show', 'dyson') }}" class="text-gray-200 hover:text-white">Dyson</a></li>
            ...
            <div>
                <h3 class="mb-4 text-lg font-semibold">Aide & Support</h3>
                <ul class="space-y-2">
                    <li><a href="{{ route('faq') }}" class="text-gray-200 hover:text-white">FAQ</a></li>
                    <li><a href="{{ route('contact') }}" class="text-gray-200 hover:text-white">Contact</a></li>
                    <li><a href="{{ route('order.tracking') }}" class="text-gray-200 hover:text-white">Suivi de commande</a></li>
                </ul>
            </div>
            <div>
