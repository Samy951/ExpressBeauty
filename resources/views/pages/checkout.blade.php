    ...
    <div class="bg-white">
        ...
        <div class="flex flex-col justify-center items-center px-4 py-12 min-h-screen">
            ...
            <div class="max-w-md text-center">
                ...
                <h1 class="mb-4 text-xl font-semibold text-gray-900">Redirection vers la page de paiement sécurisée</h1>
                <p class="mb-8 text-gray-600">Vous allez être redirigé vers notre partenaire de paiement sécurisé...</p>
                ...
                <div class="flex justify-center space-x-4">
                    <div class="flex items-center text-sm text-gray-600">
                        <svg class="mr-2 w-5 h-5 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
