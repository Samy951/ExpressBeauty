<x-layouts.app>
    ...
    <div class="container px-4 py-12 mx-auto bg-white">
        <div class="max-w-4xl mx-auto">
            <!-- Carte principale -->
            <div class="space-y-12">
                <!-- Section Informations légales -->
                <div class="bg-gradient-to-br from-[#7B1F1F] to-[#5A1717] text-white rounded-2xl shadow-xl p-8 md:p-12">
                ...
                <div class="bg-gradient-to-br from-[#7B1F1F] to-[#5A1717] text-white rounded-2xl shadow-xl p-8 md:p-12">
                    ...
                    <div class="text-gray-200">
                        <p class="mb-4">Pour toute question concernant ces mentions légales ou pour toute demande, vous pouvez nous contacter :</p>
                        <div class="space-y-2">
