@section('title', 'Politique de confidentialité - Showroom Beauty')
            ...
            <div class="max-w-3xl mx-auto">
                <div class="prose prose-lg max-w-none">
                    <div class="p-6 mb-8 bg-gray-50 rounded-xl border border-gray-100">
                        <p class="text-gray-600">Showroom Beauty ("nous", "notre" ou "nos") exploite le site web showroombeauty.fr (le "Service"). Cette page vous informe de nos politiques concernant la collecte, l'utilisation et la divulgation des données personnelles lorsque vous utilisez notre Service.</p>
                    </div>
                    ...
                    <div class="space-y-8">
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <ul class="pl-6 mb-6 list-disc space-y-2">
                                <li><strong>SERVICE</strong> : Le site web showroombeauty.fr exploité par Showroom Beauty.</li>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <ul class="pl-6 mb-6 list-disc space-y-2">
                                ...
                                <li><strong>showroombeauty_session</strong> : Identifiant unique de session.</li>
                        ...
                        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <p class="mb-4">Showroom Beauty utilise les données collectées pour :</p>
                            <ul class="pl-6 mb-6 list-disc space-y-2">
                        ...
                        <div class="bg-[#7B1F1F] text-white p-6 rounded-xl shadow-sm">
                            ...
                            <p class="mb-4">Pour toute question concernant cette Politique de confidentialité, contactez-nous :</p>
