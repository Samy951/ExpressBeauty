...
<x-layouts.app>
    ...
    <div class="bg-gradient-to-br from-[#7B1F1F] to-[#5A1717] text-white py-16">
        <div class="container px-4 mx-auto text-center">
            ...
            <p class="text-lg text-gray-200 max-w-2xl mx-auto">Les conditions générales d'utilisation de notre service</p>
        </div>
    </div>
            ...
            <div class="max-w-3xl mx-auto">
                <div class="prose prose-lg max-w-none space-y-8">
                    <div class="p-6 bg-gray-50 rounded-xl border border-gray-100">
                        <h2 class="text-xl font-semibold mb-4 text-[#7B1F1F]">1. Préambule</h2>
                        <ul class="pl-6 list-disc space-y-2">
                            <li>Les données des clients sont strictement confidentielles</li>
                    ...
                    <div class="p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                        ...
                        <ul class="pl-6 list-disc space-y-2">
                            ...
                            <li>Suivez votre commande via votre espace client</li>
                        </ul>
                    </div>
                    ...
                    <div class="p-6 bg-white rounded-xl shadow-sm border border-gray-100">
                        <h2 class="text-xl font-semibold mb-4 text-[#7B1F1F]">5. Livraison et Retours</h2>
                        <p class="mb-4 text-gray-600">Les commandes sont livrées par transporteur ou service postal, avec numéro de suivi. Le délai de livraison estimé est de 10-15 jours selon la destination. Nous sommes responsables des produits jusqu'à leur livraison.</p>
                        <p class="text-gray-600">Conformément à la législation en vigueur, vous disposez d'un délai de 14 jours à compter de la réception de votre commande pour exercer votre droit de rétractation. Les produits doivent être retournés dans leur état d'origine et complet.</p>
                    </div>
